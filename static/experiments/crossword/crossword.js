...
var CrosswordUtils = {
    PATH_TO_PNGS_OF_NUMBERS : "/static/experiments/crossword/numbers/",
        ...
        for(var r = 0; r < grid.length; r++){
            ...
            for(var c = 0; c < grid[r].length; c++){
                ...
                if(is_start_of_word) {
                    ...
                    if(cell){
                        //html.push("<td class='" + css_class + "' style=\"background-image:url('" + img_url + "');background-repeat: no-repeat; border: 1px solid #474747;\"><span class='number'>"+label+"</span>");
                        html.push("<td class='" + css_class + "' style=\"border: 1px solid #474747; position:relative;\"><span class='number'>"+label+"</span>");
                    }else{
                        //html.push("<td class='" + css_class + "' style=\"background-image:url('" + img_url + "');background-repeat: no-repeat;\">");
                        html.push("<td class='" + css_class + "' style=\"position:relative;\">");
                    };
                    label++;			
                } else {
                    //html.push("<td class='" + css_class + "' title='" + r + ", " + c + "'>");
                    if(cell){
                        html.push("<td class='" + css_class + "' style='border: 1px solid #474747;'>");
                    }else{
                ...
                if(show_answers) {
                    if(cell){
                        //html.push("<div class='cw_block' contenteditable data-char='"+char+" data-row='"+r+"' data-col='"+c+"'>"+char+"</div>");
                        html.push("<input type='text' maxlength='1' class='cw_block' data-char='"+char+"' data-row='"+r+"' data-col='"+c+"' value='"+char+"'>");
                    }else{
                        html.push("<div class='cw_blank_block' data-char='"+char+"' data-row='"+r+"' data-col='"+c+"'>"+char+"</div>");
                    };
                } else {
                    if(cell){
                        //html.push("<div class='cw_block' contenteditable data-char='"+char+"' data-row='"+r+"' data-col='"+c+"'></div>"); //&nbsp;
                        html.push("<input type='text' maxlength='1' class='cw_block' data-char='"+char+"' data-row='"+r+"' data-col='"+c+"'>");
                    }else{
                        html.push("<div class='cw_blank_block' data-char='"+char+"' data-row='"+r+"' data-col='"+c+"'>"+char+"</div>");
                    };						
                }
